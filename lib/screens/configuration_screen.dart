...
class _ConfigurationScreenState extends State<ConfigurationScreen> {
  ...
  void _resetAllSettings(String key) async {
    final prefs = await SharedPreferences.getInstance();
    prefs.clear();
                    ...
                    child: Column(
                      children: [
                        ...
                        Card(
                          ...
                          child: SwitchListTile(
                            title: Text("Mantener pantalla encendida en Modo Oscuro"),
                        ...
                        Card(
                          ...
                          child: SwitchListTile(
                            title: Text("Mantener pantalla encendida en Modo Claro"),
